...
const Custom404 = ({ rtl }) => {
    return (
        <div style={{ textAlign: "center", padding: "50px", backgroundColor: "#fff", color: "#000", height: "100vh", }}>
            <Image src="/assets/imges/404.jpg" className='img-fluid' width={600} height={400} alt='404' />
