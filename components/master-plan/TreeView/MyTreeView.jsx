...
const MyTreeView = ({
            ...
            return dataMenus.map((menu) => {
                ...
                return (
                    <TreeItem
                        ...
                        label={
                            <div
                                className={`${classes.parentIcon} ${selected === menu.id ? classes.childSelected : null
                                    }`}
                                onClick={() => {
                                    setSelected(menu.id);
                            ...
                            >
                                <p
                                    className={`${classes.childrens} ${selected === menu.id ? classes.childSelected : null
                                        }`}
                                    style={{
                                        direction: "ltr",
                                        fontFamily,
        ...
        return hasChildren || hasDataMenus ? (
            <TreeItem
                ...
                label={
                    <div className={classes.parentIcon}>
                        ...
                        <Image
                            src={`/assets/svg/${selected === nodes.id
            ...
            <TreeItem
                ...
                label={
                    ...
                    >
                        <p
                            className={`${classes.childrens} ${selected === nodes.id ? classes.childSelected : null
                                } `}
                            style={{
                                direction: "ltr",
                                fontFamily,
    ...
    return (
        <>
            ...
            {monitor ? (
                <div
                    className={`${rtl ? 'px-2' : 'px-3'} ${classes.parentIcon} ${selectMonitor ? classes.selectedMonitor : null
                        } `}
                    style={{
                ...
                >
                    ...
                    >
                        {t("implementation-objectives-monitoring")}
                    </p>
                    <Image
                        src={`/assets/svg/${selectMonitor ? "pointWhite.svg" : "pointBlack.svg"
                            }`}
                        width={25}
                        height={25}
                        alt="shape"
