...
const Feedback = ({ isFeedbackVisible, handleToggleFeedback, rtl }) => {
    ...
    return (
        <div
            className={`${classes.feedbackSection} ${isFeedbackVisible ? classes.visible : ""
                }`}
        ...
        >
            <div className={classes.feedbackContent}>
                ...
                <form onSubmit={formik.handleSubmit} className={classes.formsInput}>
                    ...
                    <div
                        className={`${classes.inputLabel} ${focusedInput === "feedbackType" ? classes.inputLabelFocused : null
